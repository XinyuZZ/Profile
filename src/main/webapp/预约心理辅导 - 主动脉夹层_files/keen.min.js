"object" != typeof JSON && (JSON = {}), function () {
        ...
        m.addRule(".spin-vml", "behavior:url(#default#VML)"), h.prototype.lines = function (a, d) {
            ...
            function g(a, g, h) {
                b(l, b(e(f(), {
                    ...
                    top: -d.width >> 1,
                    filter: h
                }), c("fill", {color: d.color, opacity: d.opacity}), c("stroke", {opacity: 0}))))
            }
    ...
    h.defaults = {}, f(h.prototype, {
        spin: function (b) {
            ...
            }), f.shadow && b(h, e(g("#000", "0 0 4px #000"), {top: "2px"})), b(d, b(h, g(f.color, "0 0 1px rgba(0,0,0,.1)")));
            return d
...
}), window.Keen = window.Keen || {}, function () {
    function a() {
    ...
    function b(a, b, c, d, e, f, g) {
        ...
        }, h.open(a, b, !0), e && h.setRequestHeader("Authorization", e), d && h.setRequestHeader("Content-Type", "application/json"), c) for (var i in c) c.hasOwnProperty(i) && h.setRequestHeader(i, c[i]);
    ...
    function d(a, b, c, d, f) {
        var g = null, h = "object" == typeof c.attributes.timeframe;
        if ("string" == typeof c.attributes.timezone) {
            var i = d.result[0].timeframe.start, j = new Date(i), k = j.getUTCHours(), l = j.getUTCMinutes(),
                m = i.slice(i.length - 6, i.length).slice(0, 1), n = 60 * k + l;
            "-" === m && (n = -n), g = n
    ...
    if (i.extend = function (a, b) {
        ...
        var e = d.constructor, f = d.constructor = function () {
            if (!i._prototyping) if (this._constructing || this.constructor == f) this._constructing = !0, e.apply(this, arguments), delete this._constructing; else if (null != arguments[0]) return (arguments[0].extend || c).call(arguments[0], d)
        };
        ...
        extend: function (a, b) {
            if (arguments.length > 1) {
                ...
                for (var f = {toSource: null}, g = ["constructor", "toString", "valueOf"], h = i._prototyping ? 0 : 1; j = g[h++];) a[j] != f[j] && e.call(this, j, a[j]);
        ...
        var h = this.getKeenUrl("/events/" + d), i = {};
        this.globalProperties && (i = this.globalProperties(d));
        for (var j in e) e.hasOwnProperty(j) && (i[j] = e[j]);
        if (a()) b("POST", h, null, i, this.writeKey, f, g); else {
            var k = JSON.stringify(i), l = Keen.Base64.encode(k);
        ...
        for (var j = 0; j < Keen._eq.length; j++) {
            var k = Keen._eq[j].shift(), l = Keen._eq[j].shift(), m = Keen._eq[j].shift(), n = Keen._eq[j].shift();
    ...
    Keen.BaseVisualization = i.extend({}), Keen.BaseVisualization.prototype.getLabel = function () {
        ...
        var c = function (a) {
            ...
            return b.height = a.height, b.width = a.width, b.lineWidth = a.lineWidth, b.colors = [a.color], b.backgroundColor = a.backgroundColor, b.title = a.title, b.fontName = a.font, b.hAxis = {
                ...
                title: a.yAxisLabel,
                viewWindow: {}
            }, null != a.yAxisMin && (b.vAxis.viewWindow.min = a.yAxisMin), null != a.yAxisMax && (b.vAxis.viewWindow.max = a.yAxisMax), a.showLegend || (b.legend = {position: "none"}), null != a.xAxisLabelAngle && (b.hAxis.slantedText = !0, b.hAxis.slantedTextAngle = a.xAxisLabelAngle), b.chartArea = {
            ...
            if (f.addRows(_.map(this.data, function (a) {
                var c = e(a.timeframe.start), f = d(c, this.query.attributes.interval, this.query, b, g);
                return g++, null == a.value && (a.value = 0), [f, a.value]
            }, this)), google) {
                var h = new google.visualization.AreaChart(a), i = c(this.options);
                h.draw(f, i)
        ...
        var c = [], f = function (a) {
            var b = {};
            return b.height = a.height, b.width = a.width, b.lineWidth = a.lineWidth, b.colors = a.colors, b.backgroundColor = a.backgroundColor, b.title = a.title, b.fontName = a.font, b.hAxis = {title: a.xAxisLabel}, b.vAxis = {
                title: a.yAxisLabel,
                viewWindow: {min: 0}
            }, a.showLegend || (b.legend = {position: "none"}), null != a.xAxisLabelAngle && (b.hAxis.slantedText = !0, b.hAxis.slantedTextAngle = a.xAxisLabelAngle), b.chartArea = {
                left: a.chartAreaLeft,
                top: a.chartAreaTop,
                height: a.chartAreaHeight,
                width: a.chartAreaWidth
            ...
            if (h.addColumn("string", "Date"), _.each(g, function (a) {
                ...
                var c = [], f = e(a.timeframe.start), g = d(f, this.query.attributes.interval, this.query, b);
                c.push(g), _.each(a.value, function (a) {
                    null == a.result && (a.result = 0), c.push(a.result)
                }, this), 1 == c.length && c.push(null), h.addRow(c)
            }, this), google) {
                var i = new google.visualization.LineChart(a), j = f(this.options);
                i.draw(h, j)
            } else console.log("Charting is not yet ready.  Are you waiting for onChartsReady?")
        }, this);
        ...
        var c = function (a) {
            var b = {};
            return b.legend = {}, b.height = a.height, b.width = a.width, b.title = a.title, b.colors = [a.color], b.fontName = a.font, b.backgroundColor = a.backgroundColor, a.showLegend || (b.legend.position = "none"), b.titleTextStyle = {color: a.fontColor}, b.legend.textStyle = {color: a.fontColor}, b.chartArea = {
                left: a.chartAreaLeft,
                top: a.chartAreaTop,
                height: a.chartAreaHeight,
                width: a.chartAreaWidth
            }, b.vAxis = {viewWindow: {min: 0}, format: "#"}, b.bar = {groupWidth: "90%"}, b
        }, d = _.bind(function (b) {
            ...
            for (var e = null, f = 0; f < this.numbers.length; f++) {
                ...
                var g = 0 === e ? 0 : Math.round(this.numbers[f] / e * 100), h = this.steps[f].event_collection;
        ...
        getResponse: function (a) {
            ...
            if (_.isUndefined(this.client.readKey)) console.log("Error: Please add a readKey to Keen.configure() to perform analysis."); else {
                var d = this.getPath(), e = this.buildParams();
                d += "?", d += g(e);
        ...
        return this.attributes.filters.push({property_name: a, operator: b, property_value: c}), this
        ...
        constructor: function (a, b, c) {
            ...
            if (!_.isUndefined(this.attributes.actorProperty)) for (var a = 0; a < this.steps.length; a++) _.isUndefined(this.steps[a].actor_property) && (this.steps[a].actor_property = this.attributes.actorProperty);
            return {
                api_key: this.client.readKey,
                steps: this.steps,
                timeframe: this.attributes.timeframe,
        ...
        constructor: function (a, b) {
            _.isUndefined(b) && (b = {}), this.attributes = _.defaults(b, {filters: []}), this.attributes.eventCollection = a, _.isUndefined(this.attributes.timezone) && (this.attributes.timezone = f())
        }, buildParams: function () {
            return {
                event_collection: this.attributes.eventCollection,
                actor_property: this.attributes.actorProperty,
        ...
        var a = new Date(this.getFullYear(), -1, 1), b = new Date(this.getFullYear(), 6, 1);
